...
class TestDictToXML:
    ...
    def test_no_root(self):
        pytest.raises(ValueError, unparse, {})

    def test_multiple_roots(self):
        pytest.raises(ValueError, unparse, {'a': '1', 'b': '2'})
        pytest.raises(ValueError, unparse, {'a': ['1', '2', '3']})
    ...
    def test_fulldoc(self):
        xml_declaration_re = re.compile('^' + re.escape('<?xml version="1.0" encoding="utf-8"?>'))
